...
public class Squirrel extends Enemy {
    ...
    public Squirrel(int x, int y, GamePanel gp) {
        super(x, y, gp);
    }
    ...
    public void getImage() {
        try {
            image = ImageIO.read(getClass().getResourceAsStream("/res/enemy/squirrel.png"));
            image2 = ImageIO.read(getClass().getResourceAsStream("/res/enemy/deadsquirrel.png"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
